...
const Contact = () => {
    ...
    return (
        <div className="divide-x divide-indigo-600">
            <Helmet>SK Real estate | Contact </Helmet>
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                            ...
                            <div className="mb-3 w-full">
                                <label className="block font-medium mb-[2px] text-indigo-700" htmlFor="exampleInput90">
                                    Name
                                </label>
                            ...
                            <button type="button"
                                    className="mb-6 inline-block w-full rounded bg-indigo-600 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-indigo-500">
                                Send
                            </button>
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                                    <div className="flex items-start">
                                        <div className="shrink-0">
                                            <div
                                                className="inline-block rounded-md bg-indigo-400-100 p-4 text-indigo-700">
                ...
                <section className="bg-gray-100">
                    <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
                        <div className="max-w-2xl lg:max-w-4xl mx-auto text-center">
                            ...
                            <p className="mt-4 text-lg text-gray-500"> We are always there to hear from you..</p>
                        </div>
                        <div className="mt-16 lg:mt-20">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="rounded-lg overflow-hidden">

                                    <div className="h-[500px] w-full border rounded-xl">
                                        <GoogleMapReact
                                ...
                                <div>
                                    <div className="max-w-full mx-auto rounded-lg overflow-hidden">
                                        <div className="px-6 py-4">
                                            ...
                                            <p className="mt-1 text-gray-600">Agrabad, Chittagong, Bangladesh</p>
                                        </div>
                                        ...
                                        <div className="border-t border-gray-200 px-6 py-4">
                                            ...
                                            <p className="mt-1 text-gray-600">Email: info@sk.com</p>
