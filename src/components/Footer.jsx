                        ...
                        <div className="-mx-4 flex flex-wrap justify-between">
                            <div className="px-4 my-4 w-full xl:w-1/5">
                                    ...
                                    <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                                        <g fill="none" fill-rule="evenodd">
                                                ...
                                                <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512"
                                                      font-weight="bold">
                                                    <tspan  y="500">SK Real Estate</tspan>
                                                </text>
                                        </g>
                                    </svg>
                                ...
                                <p className="text-justify">
                                    In the last 22 years, SK has completed a significant number of projects in all over Dhaka and Chittagong cities. Around more than hundred projects both residential and commercial are now ongoing in Dhaka and Chittagong cities.
                                </p>
                            </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="-mx-4 flex flex-wrap justify-between">
                            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                                Copyright © 2020
                                - {moment().format('YYYY')}
                                SK Real Estate. All Rights Reserved.
                            </div>
                            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                                Stay With SK Real Estate ❤️
                            </div>
                        </div>
                    </div>
                </div>
