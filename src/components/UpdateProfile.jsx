...
const UpdateProfile = () => {
    ...
    return (
        <div>
            <Helmet>SK Real estate | Update Profile </Helmet>

            <section className="py-10 my-auto dark:bg-gray-900">
                <h1
                    className="lg:text-3xl md:text-2xl sm:text-xl xs:text-xl font-serif font-extrabold ml-6 mb-2 dark:text-gray-900">
                    .
                </h1>
                        ...
                        <div className="">
                            ...
                            <form onSubmit={handleUpdate}>
                                ...
                                <div
                                    ...
                                    <div
                                        className="mx-auto my-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
                                        <img className="object-cover object-center h-32" src={user.photoURL}
                                             alt='Update your photo'/>
                                    </div>
                                    ...
                                    <div className="flex justify-end">
                                        ...
                                        <div
                                            ...
                                            <label htmlFor="upload_cover"
                                                   className="inline-flex items-center gap-1 cursor-pointer">Cover
                                ...
                                <h2 className="text-center mt-1 font-semibold dark:text-gray-300">Update Name and
                                    Profile Picture URL
                                </h2>
                                <h2 className="text-center mt-1 font-small dark:text-gray-300"> [ Note: You cant update email. ]
                                </h2>
                                <div
                                ...
                                <div
                                    ...
                                    <div className="w-full">
                                        <label htmlFor="" className="mb-2 dark:text-gray-300">Email</label>
                                        <input
                                            type="text"
                                            className="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                                    ...
                                    <div className="w-full">
                                        <label htmlFor="" className="mb-2 dark:text-gray-300">Photo URL</label>
                                        <input
                                            type="url"
                                            name="photoUrl"
                                            className="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
